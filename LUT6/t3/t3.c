...
void changeList(int oldLen, int newLen, node_t *pAlku);
        ...
        do {
                ...
                switch (valinta) {
                        ...
                        case 2 :
                                ...
                                if (listLen > prevLen || listLen < prevLen) {
                                        changeList(prevLen, listLen, pStart);
                                } else {
                                        break;
                                }
                                prevLen = listLen;
...
void changeList(int oldLen, int newLen, node_t *pAlku) {
        ...
        while (i < newLen) {
                if (!(pAlku = (node_t *)malloc(sizeof(node_t)))) {
                        perror("Muistin varaus epäonnistui");
                        exit(0);
                }
                pAlku->data = i;
